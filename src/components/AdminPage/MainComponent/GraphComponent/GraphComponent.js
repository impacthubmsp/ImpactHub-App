  ...
  render() {
    ...
    return (
      <div className="viewContainer">
        ...
        {showGraph==='today' && <Line id="todayLine" data={monthlyData}
          options={{
            title: {
              display: true,
              text: 'Visits Today',
        ...
        {showGraph=="thisWeek" && <Line id="weekLine" data={monthlyData}
          options={{
            title: {
              display: true,
        ...
        {showGraph==='thisYear' && <Line id="monthLine" data={monthlyData}
          options={{
            title: {
              display: true,
